...
class SendEmail {
    ...
    {
        $this->setTemplate('agent/email/tpl/signup');
    ...
    public function register($agent, $user, $authCode)
    {
        $this->setTemplate('agent/email/tpl/register');
        $subject = 'Signup Confirmation';
    
        $viewContent = new ViewModel(array('agent' => $agent,
                                            'user' => $user,
                                            'authCode' => $authCode
                                     ));
        $viewContent->setTemplate($this->template);
    ...
    {
        $this->setTemplate('agent/email/tpl/event');
    ...
    {
        $this->setTemplate('agent/email/tpl/notice');
    ...
    {
        $this->setTemplate('agent/email/tpl/request');
    ...
    {
        $this->setTemplate('agent/email/tpl/response');
    ...
    {
        $this->setTemplate('agent/email/tpl/receipt');
        $subject = 'Receipt';
    ...
    { 
        ...
        $pdf = new PdfModel();
        $pdf->setTemplate('agent/email/tpl/receipt');
    ...
    */
    protected function send($from, $to, $subject, $content, $attachments = null) {
        ...
        $viewLayout = new ViewModel(array('content' => $content));
        $viewLayout->setTemplate('agent/email/tpl/layout');
        $content = $this->renderer->render($viewLayout);
